...
Objective: Audit the current project structure and generate a configuration map.
Output Target: Create a new file named framework_details.md in the root directory.

Phase 1: Tech Stack Identification

Scan the root directory files to determine the core technology.
...
Step Definitions: Locate the Java classes that contain @Given, @When, @Then annotations.
...
Wait Strategy: Is the project using Thread.sleep, Explicit Waits, or FluentWaits?
